...
*/
  ...
  if (jello->incPlanePresent == 1){
    ...
    int count = 0;
    jello->planepoints[0].x = -2;
    jello->planepoints[0].y = -2;
    jello->planepoints[0].z = (0 - (-2*jello->a + -2*jello->b + jello->d))/jello->c;
    jello->planepoints[1].x = -2;
    jello->planepoints[1].y = 2;
    jello->planepoints[1].z = (0 - (-2*jello->a + 2*jello->b + jello->d))/jello->c;
    jello->planepoints[2].x = 2;
    jello->planepoints[2].y = 2;
    jello->planepoints[2].z = (0 - (2*jello->a + 2*jello->b + jello->d))/jello->c;
    jello->planepoints[3].x = 2;
    jello->planepoints[3].y = -2;
    jello->planepoints[3].z = (0 - (2*jello->a + -2*jello->b + jello->d))/jello->c;
  }
  ...
  if (jello->incPlanePresent == 1){ 
    if(0 < jello->p[4][4][4].x*jello->a + jello->p[4][4][4].y*jello->b + jello->p[4][4][4].z*jello->c + jello->d)
      jello->planeright = true;
    else
      jello->planeright = false;
  }
  fclose(file);
