...
void display()
{
  ...
  */
  ...
  GLfloat lP6[] = { 2.999, 2.999, 2.999, 1.0 };
  GLfloat lP7[] = { -2.999, 2.999, 2.999, 1.0 };
  
  // jelly material color
  GLfloat mKa[] = { 0.255, 0.412, 0.882, 1.0 };
  GLfloat mKd[] = { 0.255, 0.412, 0.882, 0.95 };
